      ...
      <div className="px-6 py-5 border-b border-sidebar-border">
        <div className="flex items-center justify-between">
          <div className="flex flex-col items-start gap-2">
            <img src={klikklaarSeoLogo} alt="KlikKlaar SEO" className="h-8 invert brightness-[2] mix-blend-screen" />
            <img src={klikklaarWebLogo} alt="KlikKlaar WEB" className="h-8 invert brightness-[2] mix-blend-screen" />
